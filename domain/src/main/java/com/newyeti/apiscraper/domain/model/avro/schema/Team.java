...
public class Team extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3629148917297959396L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Team\",\"namespace\":\"com.newyeti.apiscraper.domain.model.avro.schema\",\"fields\":[{\"name\":\"id\",\"type\":[\"null\",\"int\"],\"default\":null},{\"name\":\"logo\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"name\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null}]}");
   ...
   */
  public Team(java.lang.Integer id, java.lang.String logo, java.lang.String name) {
    this.id = id;
    this.logo = logo;
    this.name = name;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: logo = (java.lang.String)value$; break;
   ...
   */
  public static com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder newBuilder() {
    return new com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder();
  }
   ...
   * @return A new Team RecordBuilder
   */
  public static com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder newBuilder(com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder other) {
    return new com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder(other);
  }
   ...
   * @return A new Team RecordBuilder
   */
  public static com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder newBuilder(com.newyeti.apiscraper.domain.model.avro.schema.Team other) {
    return new com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Team>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.newyeti.apiscraper.domain.model.avro.schema.Team other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder setId(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder setLogo(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder clearLogo() {
      logo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.newyeti.apiscraper.domain.model.avro.schema.Team.Builder clearName() {
      name = null;
    ...
    public Team build() {
      try {
        ...
        record.logo = fieldSetFlags()[1] ? this.logo : (java.lang.String) defaultValue(fields()[1]);
